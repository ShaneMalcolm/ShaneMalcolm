...
class Dashboard {
    ...
    public function __construct($userEmail, $database) {
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Thank you for choosing <b>ABC Laboratories.</b> <br><br>
                             We look forward to serving you and helping you on your journey to <b>better health.</b> 
                            </p>
...
$dashboard = new Dashboard($_SESSION["user"], $database);
