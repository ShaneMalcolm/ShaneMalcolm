                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@abclabs.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
...
?>
    ...
    <?php 
    if($_GET && isset($_GET["action"]) && $_GET["action"] === "view" && isset($_GET["id"])){
    ...
    if ($_GET && isset($_GET["action"]) && $_GET["action"] === "edit" && isset($_GET["id"])) {
        $id = $_GET["id"];
        $action = $_GET["action"];
        $sqlmain = "SELECT * FROM patient WHERE pid='$id'";
        $result = $database->query($sqlmain);
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        <a class="close" href="patient.php">&times;</a>
                        <div class="content">
                        <form action="upload_patient_record.php" method="post" enctype="multipart/form-data">

                                <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Upload Patient Record.</p><br><br>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                            <td class="label-td" colspan="2">
                                <label for="record_file" class="form-label">Upload Patient Records (PDF): </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="file" name="record_file" id="record_file" accept=".pdf"><br><br>
                            </td>
                        </tr>
                        
                                    <tr>
                                        <td colspan="2">
                                            <input type="submit" class="login-btn btn-primary-soft btn" value="Upload">
                                            <a href="patient.php"><button class="login-btn btn-primary-soft btn">Cancel</button></a>
                                        </td>
                                    </tr>
                                </table>
                            </form>
